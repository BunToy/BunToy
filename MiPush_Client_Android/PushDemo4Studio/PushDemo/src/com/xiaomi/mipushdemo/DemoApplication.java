...
public class DemoApplication extends Application {
    ...
    private static final String APP_ID = "2882303761517791759";
    // user your appid the key.
    private static final String APP_KEY = "5751779181759";

    // 此TAG在adb logcat中检索自己所需要的信息， 只需在命令行终端输入 adb logcat | grep
    // com.xiaomi.mipushdemo
    public static final String TAG = "com.xiaomi.mipushdemo.bun";
